...
void Controller::handleKeyPresses()
{
    ...
    if (sf::Keyboard::isKeyPressed(sf::Keyboard::W))
        d_view3D.translateEye(0, 0, -30);
    if (sf::Keyboard::isKeyPressed(sf::Keyboard::S))
        d_view3D.translateEye(0, 0, 30);
    if (sf::Keyboard::isKeyPressed(sf::Keyboard::A))
        d_view3D.translateEye(-30, 0, 0);
    if (sf::Keyboard::isKeyPressed(sf::Keyboard::D))
        d_view3D.translateEye(30, 0, 0);
    if (sf::Keyboard::isKeyPressed(sf::Keyboard::Q))
        d_view3D.translateEye(0, 30, 0);
    if (sf::Keyboard::isKeyPressed(sf::Keyboard::E))
        d_view3D.translateEye(0, -30, 0);

    // Rotation (taking zoom into account)
    if (sf::Keyboard::isKeyPressed(sf::Keyboard::Up))
        d_view3D.getEyeRotation().x += 0.05 / d_view3D.getZoom();
    if (sf::Keyboard::isKeyPressed(sf::Keyboard::Down))
        d_view3D.getEyeRotation().x -= 0.05 / d_view3D.getZoom();
    if (sf::Keyboard::isKeyPressed(sf::Keyboard::Left))
        d_view3D.getEyeRotation().y += 0.05 / d_view3D.getZoom();
    if (sf::Keyboard::isKeyPressed(sf::Keyboard::Right))
        d_view3D.getEyeRotation().y -= 0.05 / d_view3D.getZoom();
    // for now not active, would require even more rotation I think
    //if (sf::Keyboard::isKeyPressed(sf::Keyboard::Numpad1))
    //    d_view3D.getEyeRotation().z -= 0.05;
